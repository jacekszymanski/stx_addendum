...
abstract Method<A,B>(A->B) from A->B to A->B{
  ...
  public function call(args:Array<Dynamic>){
	...
	public function pair<C,D>(fn2:C -> D) {
		return function(t){
      return tuple2(apply(t.fst()),fn2(t.snd()));
    }
	}
}